...
//
// Mostly read-only. The ONE write is the per-central monitoring_enabled toggle
// (PATCH /api/centrals/:id/monitoring): admin-password gated + confirm() +
// audit_logs. Heavier Phase 2B controls (MASTER/flags/kick-scan) stay out and
// exist via DB/runbook; per RFC-0062 §7 they'd want RBAC orchestrator_devices.control.
//
