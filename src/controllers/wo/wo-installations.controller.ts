...
import { installationService } from '../../services/wo/InstallationService';
import { maintenanceTaskService } from '../../services/wo/MaintenanceTaskService';
import { fileAssetService } from '../../services/FileAssetService';
import {
  InstallSchema,
  UpdateInstallationSchema,
  UpdateInstallationImageSchema,
} from '../../dto/request/wo/InstallationDTO';
import {
  CreateMaintenanceTaskSchema,
  UpdateMaintenanceTaskSchema,
} from '../../dto/request/wo/MaintenanceTaskDTO';
...
import { TcType, InstallationStatus } from '../../domain/entities/wo/Installation';
...
// -----------------------------------------------------------------------------
// GET /wo/installations/:id/audit  — revision log
// -----------------------------------------------------------------------------
