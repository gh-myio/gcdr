import { InstallationStatus } from '../../domain/entities/qrc/Installation';
import { Visita } from '../../domain/entities/qrc/Visita';
...
import { IVisitaAmbienteRepository } from '../../repositories/interfaces/qrc/IVisitaAmbienteRepository';
import { visitaAmbienteRepository } from '../../repositories/qrc/VisitaAmbienteRepository';
...
export class QrcReportService {
  ...
  /**
   * Per-customer installation progress. Used by /qrc/customers
   * (with `?include=stats`) and /qrc/customers/:id/report.
   */
...
export const qrcReportService = new QrcReportService();
