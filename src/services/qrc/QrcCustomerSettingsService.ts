...
import {
  QrcCustomerSettingsRepository,
  qrcCustomerSettingsRepository,
} from '../../repositories/qrc/QrcCustomerSettingsRepository';
import { CustomerRepository } from '../../repositories/CustomerRepository';
import { ICustomerRepository } from '../../repositories/interfaces/ICustomerRepository';
import { IQrcCustomerSettingsRepository } from '../../repositories/interfaces/qrc/IQrcCustomerSettingsRepository';
...
export class QrcCustomerSettingsService {
  constructor(
    private readonly settingsRepo: IQrcCustomerSettingsRepository = qrcCustomerSettingsRepository,
  ...
  async enable(
    ...
    return this.settingsRepo.enable(tenantId, customerId, {
      ...
      qrcMetadata:      input.qrcMetadata ?? {},
    }, createdBy);
  }

  async update(tenantId: string, customerId: string, input: UpdateInput): Promise<QrcCustomerSettings> {
    const patch: Parameters<IQrcCustomerSettingsRepository['update']>[2] = {};
    ...
    if (input.qrcMetadata !== undefined)      patch.qrcMetadata = input.qrcMetadata;
  ...
  /**
   * Soft-disable: drops the qrc_customer_settings row. The customer row
...
export const qrcCustomerSettingsService = new QrcCustomerSettingsService();
