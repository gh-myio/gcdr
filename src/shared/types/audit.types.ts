...
export enum EventType {
  ...
  CUSTOMER_FORCE_DELETED = 'CUSTOMER_FORCE_DELETED',

  // === Public Single Apps (RFC-0020) ===
  PUBLIC_APP_CREATED = 'PUBLIC_APP_CREATED',
  PUBLIC_APP_UPDATED = 'PUBLIC_APP_UPDATED',
  PUBLIC_APP_ARCHIVED = 'PUBLIC_APP_ARCHIVED',
  PUBLIC_APP_RESPONSE_SUBMITTED = 'PUBLIC_APP_RESPONSE_SUBMITTED',
  PUBLIC_APP_RESPONSE_REVISED = 'PUBLIC_APP_RESPONSE_REVISED',
  PUBLIC_APP_RESPONSE_STATUS_CHANGED = 'PUBLIC_APP_RESPONSE_STATUS_CHANGED',
  ...
  // === Customer Config Document (RFC-0057) ===
  CUSTOMER_CONFIG_UPDATED = 'CUSTOMER_CONFIG_UPDATED',
  CUSTOMER_CONFIG_SECRET_UPDATED = 'CUSTOMER_CONFIG_SECRET_UPDATED',
  CUSTOMER_CONFIG_SECRET_REVEALED = 'CUSTOMER_CONFIG_SECRET_REVEALED',

  // === Customer Integration Sync (RFC-0033) ===
  CUSTOMER_INTEGRATION_SYNC = 'CUSTOMER_INTEGRATION_SYNC',
  CUSTOMER_INTEGRATION_DISABLED = 'CUSTOMER_INTEGRATION_DISABLED',
  CUSTOMER_INTEGRATION_RESET = 'CUSTOMER_INTEGRATION_RESET',
  CUSTOMER_INTEGRATION_ITEMS_UPDATED = 'CUSTOMER_INTEGRATION_ITEMS_UPDATED',
  CUSTOMER_INTEGRATION_CREDENTIALS_REVEALED = 'CUSTOMER_INTEGRATION_CREDENTIALS_REVEALED',
  ...
  CENTRAL_MANUAL_RECHECK = 'CENTRAL_MANUAL_RECHECK',
  CENTRAL_ENROLL_TOKEN_ISSUED = 'CENTRAL_ENROLL_TOKEN_ISSUED',
  CENTRAL_BACKUP_INITIATED = 'CENTRAL_BACKUP_INITIATED',
  CENTRAL_BACKUP_CONFIRMED = 'CENTRAL_BACKUP_CONFIRMED',
  CENTRAL_BACKUP_DOWNLOADED = 'CENTRAL_BACKUP_DOWNLOADED',
  CENTRAL_RESTORE_INITIATED = 'CENTRAL_RESTORE_INITIATED',
  CENTRAL_RESTORE_PROGRESS = 'CENTRAL_RESTORE_PROGRESS',
  CENTRAL_RESTORE_COMPLETED = 'CENTRAL_RESTORE_COMPLETED',
  CENTRAL_RESTORE_FAILED = 'CENTRAL_RESTORE_FAILED',
  ...
  // === Consumption Goals (RFC-0052) ===
  GOAL_MARGIN_CHANGED = 'GOAL_MARGIN_CHANGED',
