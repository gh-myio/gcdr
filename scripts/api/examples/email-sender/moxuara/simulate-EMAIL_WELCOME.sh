#!/bin/bash
# Simula o EMAIL_SENDER recebendo um evento NEW_USER para Moxuara
...
PAYLOAD='{
  "data": {
    ...
    "activation": {
      "link":      "https://app.myio.com.br/activate?token=eyJhbGciOiJIUzI1NiJ9.xyz789",
...
OUTPUT_FILE="${OUTPUT_DIR}/welcome-email-moxuara.html"
