#!/bin/bash
# Simula o EMAIL_SENDER recebendo um evento NOTIFICATION para Mestre Álvaro
...
PAYLOAD='{
  "data": {
    ...
    "notification": {
      ...
      "body":        "O sistema MYIO estará em manutenção das 02h às 04h do dia 07/03/2026. Durante este período os dashboards poderão ficar indisponíveis. Salve seus dados antes deste horário.",
      "level":       "WARNING",
      "actionLabel": "Ver detalhes",
      "actionUrl":   "https://app.myio.com.br/notices/maint-2026-03-07"
    }
  }
}'
...
OUTPUT_FILE="${OUTPUT_DIR}/notification-email-mestrealvaro.html"
