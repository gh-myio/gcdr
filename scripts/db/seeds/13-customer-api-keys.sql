...
BEGIN
    ...
    VALUES (
        ...
        '["customers:read", "bundles:read", "rules:read", "rules:write", "devices:read", "devices:write", "alarms:read", "alarms:write", "alarms:acknowledge", "telemetry:read", "telemetry:write", "simulator:read", "simulator:write"]',
        NOW() + INTERVAL '365 days',
        0,
        true,
        v_admin_id,
