-- =============================================================================
-- OPS: Rio Poty — Device Offline Rule (internal)
-- =============================================================================
-- Customer : Rio Poty (8f9af056-10c2-4cd4-a45f-ab0c99377aca)
-- Tenant   : 11111111-1111-1111-1111-111111111111
-- Central  : 1817cd70-cf03-11f0-998e-25174baff087  (heartbeat source)
--
...
DECLARE
  ...
  v_customer_id UUID := '8f9af056-10c2-4cd4-a45f-ab0c99377aca';
  v_central_id  UUID := '1817cd70-cf03-11f0-998e-25174baff087';
  v_rule_id     UUID;
BEGIN
  ...
  IF EXISTS (
    ...
    RAISE NOTICE 'Device Offline rule already exists for Rio Poty — skipping.';
    RETURN;
  END IF;
  ...
  VALUES (
    ...
    '["device-offline", "internal", "rio-poty", "connectivity"]'::jsonb,
...
FROM rules
WHERE customer_id = '8f9af056-10c2-4cd4-a45f-ab0c99377aca'
  AND type        = 'DEVICE_OFFLINE';
