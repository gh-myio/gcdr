-- =============================================================================
-- OPS: Moxuara — Device Offline Rule (internal)
-- =============================================================================
...
DECLARE
  ...
  v_central_id  UUID := 'd3202744-05dd-46d1-af33-495e9a2ecd52';
  v_rule_id     UUID;
BEGIN
  ...
  IF EXISTS (
    ...
    RAISE NOTICE 'Device Offline rule already exists for Moxuara — skipping.';
    RETURN;
  END IF;
  ...
  VALUES (
    ...
    '["device-offline", "internal", "moxuara", "connectivity"]'::jsonb,
