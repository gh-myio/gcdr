-- =============================================================================
-- OPS: Shopping da Ilha — Device Offline Rule (internal)
-- =============================================================================
-- Customer : Shopping da Ilha (f1fcf434-532b-428a-a5e1-0b68e8ae1056)
-- Tenant   : 11111111-1111-1111-1111-111111111111
-- Central  : c455ac60-b685-11f0-9898-a53e89467408  (heartbeat source)
--
...
DECLARE
  ...
  v_customer_id UUID := 'f1fcf434-532b-428a-a5e1-0b68e8ae1056';
  v_central_id  UUID := 'c455ac60-b685-11f0-9898-a53e89467408';
  v_rule_id     UUID;
BEGIN
  ...
  IF EXISTS (
    ...
    RAISE NOTICE 'Device Offline rule already exists for Shopping da Ilha — skipping.';
    RETURN;
  END IF;
  ...
  VALUES (
    ...
    'Device Offline — Shopping da Ilha',
    ...
    '["device-offline", "internal", "shopping-da-ilha", "connectivity"]'::jsonb,
...
FROM rules
WHERE customer_id = 'f1fcf434-532b-428a-a5e1-0b68e8ae1056'
  AND type        = 'DEVICE_OFFLINE';
