import { VisitaService } from '../../../../src/services/wo/VisitaService';
import { IVisitaRepository } from '../../../../src/repositories/interfaces/wo/IVisitaRepository';
import {
  IVisitaAmbienteRepository,
  IVisitaAmbienteImageRepository,
} from '../../../../src/repositories/interfaces/wo/IVisitaAmbienteRepository';
import {
  IVisitaProductRepository,
  IVisitaProductImageRepository,
} from '../../../../src/repositories/interfaces/wo/IVisitaProductRepository';
import { IVisitaObservationRepository } from '../../../../src/repositories/interfaces/wo/IVisitaObservationRepository';
import { IVisitaAuditRepository } from '../../../../src/repositories/interfaces/wo/IVisitaAuditRepository';
import { Visita } from '../../../../src/domain/entities/wo/Visita';
import { VisitaAmbiente } from '../../../../src/domain/entities/wo/VisitaAmbiente';
import { VisitaProduct } from '../../../../src/domain/entities/wo/VisitaProduct';
