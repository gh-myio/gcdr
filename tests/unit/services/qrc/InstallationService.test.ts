import { InstallationService } from '../../../../src/services/qrc/InstallationService';
import { IInstallationRepository } from '../../../../src/repositories/interfaces/qrc/IInstallationRepository';
import { IInstallationImageRepository } from '../../../../src/repositories/interfaces/qrc/IInstallationImageRepository';
...
import { InstallationImage } from '../../../../src/domain/entities/qrc/InstallationImage';
import { InstallationAudit } from '../../../../src/domain/entities/qrc/InstallationAudit';
...
describe('InstallationService', () => {
  ...
  describe('install (idempotent)', () => {
    ...
    it('resolves device by (addrLow, addrHigh) when deviceId is not provided', async () => {
      deviceRepo.findByQrcAddress.mockResolvedValue(mockDevice);
      repo.getByDeviceId.mockResolvedValue(null);
      repo.create.mockResolvedValue(mockInstallation);
      ...
      expect(deviceRepo.findByQrcAddress).toHaveBeenCalledWith(tenantId, customerId, 12, 7);
    ...
    it('throws NotFoundError when QR address does not match a device', async () => {
      deviceRepo.findByQrcAddress.mockResolvedValue(null);
