#!/bin/bash
# Fetch simplified alarm bundle for Moxuara with version check (304 cache validation)
...
# Central Moxuara: e982edf9-edb1-4aa6-8a14-4782465ae5a3 (MOXUARA-GATEWAY)
...
echo "=== Bundle Version Check — Moxuara ==="
echo "Log: $LOG_FILE"
