#!/bin/bash
# Fetch simplified alarm bundle for Shopping da Ilha and save to JSON file
...
API_KEY="gcdr_shopping_da_ilha_bundle_key_2026"
CENTRAL_ID=""
OUTPUT_FILE="$(dirname "$0")/simple_bundle_output.json"

echo "Fetching simplified bundle — Shopping da Ilha..."
