#!/bin/bash
# Fetch simplified alarm bundle for Mestre Álvaro with version check (304 cache validation)
...
# Redirect all output: colors to terminal, plain text to log file
exec > >(tee >(sed 's/\x1b\[[0-9;]*m//g' >> "$LOG_FILE")) 2>&1

echo "=== Bundle Version Check — Mestre Álvaro ==="
echo "Log: $LOG_FILE"
