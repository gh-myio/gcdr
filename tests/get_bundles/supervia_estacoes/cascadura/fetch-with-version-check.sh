#!/bin/bash
# Fetch simplified alarm bundle — Supervia CASCADURA — version check (304 cache validation)
...
CENTRAL_ID="e6cda66f-9641-4669-8081-7349df8353c3"
...
echo "=== Bundle Version Check — Supervia CASCADURA ==="
echo "Log: $LOG_FILE"
