#!/bin/bash
# Fetch simplified alarm bundle — Supervia DEODORO — version check (304 cache validation)
...
CENTRAL_ID="adb43bf6-6107-44fa-b786-6e88c150d779"
...
echo "=== Bundle Version Check — Supervia DEODORO ==="
echo "Log: $LOG_FILE"
