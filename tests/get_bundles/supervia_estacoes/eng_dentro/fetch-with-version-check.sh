#!/bin/bash
# Fetch simplified alarm bundle — Supervia ENG. DE DENTRO — version check (304 cache validation)
# Usa central 1 por padrão. Para central 2, ajuste CENTRAL_ID abaixo.
...
# Central 1: 16618030-837b-11f0-a06d-e9509531b1d5
# Central 2: a5708ba0-8389-11f0-a06d-e9509531b1d5
CENTRAL_ID="0e8366f3-6a0c-478e-a486-fec481fe7448"
...
echo "=== Bundle Version Check — Supervia ENG. DE DENTRO ==="
echo "Log: $LOG_FILE"
