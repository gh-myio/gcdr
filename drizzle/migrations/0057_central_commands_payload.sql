-- Migration 0057: central_commands.payload — the SET_WIFI command carries the
...
--
-- Separate file from 0056: this uses no enum value, and keeping the ADD VALUE
-- alone in 0056 avoids the "new enum value used in the same transaction" error.
--
